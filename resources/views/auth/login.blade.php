...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('logava/css/style.css')}}">
            ...
            <div class="form-holder">
                <div class="form-content">
                            ...
                            <div class="svgContainer">
                                    <div>
                                        <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                                            ...
                                            <g class="mouth" data-svg-origin="100.2220687866211 104" transform="matrix(1,0,0,1,0.03435944427490234,-0.011618640594482477)" style="transform-origin: 0px 0px 0px;">
                                                <path class="mouthBG" fill="#617E92" d="M100 110.2c-9 0-16.2-7.3-16.2-16.2 0-2.3 1.9-4.2 4.2-4.2h24c2.3 0 4.2 1.9 4.2 4.2 0 9-7.2 16.2-16.2 16.2z" data-original="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"></path>
                                                ...
                                                <defs>
                                                    <path id="mouthMaskPath" d="M100 110.2c-9 0-16.2-7.3-16.2-16.2 0-2.3 1.9-4.2 4.2-4.2h24c2.3 0 4.2 1.9 4.2 4.2 0 9-7.2 16.2-16.2 16.2z" data-original="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"></path>
                                                </defs>
                                                <clipPath id="mouthMask">
                                                    <use xlink:href="#mouthMaskPath" overflow="visible"></use>
                                                </clipPath>
                                                <g clip-path="url(#mouthMask)">
                                                    <g class="tongue" data-svg-origin="92 99" transform="matrix(1,0,0,1,0,2)">
                                                ...
                                                <path clip-path="url(#mouthMask)" class="tooth" style="fill:#FFFFFF;" d="M106,97h-4c-1.1,0-2-0.9-2-2v-2h8v2C108,96.1,107.1,97,106,97z" data-svg-origin="100 93" transform="matrix(1,0,0,1,3,-2)"></path>
                                                <path class="mouthOutline" fill="none" stroke="#3A5E77" stroke-width="2.5" stroke-linejoin="round" d="M100 110.2c-9 0-16.2-7.3-16.2-16.2 0-2.3 1.9-4.2 4.2-4.2h24c2.3 0 4.2 1.9 4.2 4.2 0 9-7.2 16.2-16.2 16.2z" data-original="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"></path>
                                            </g>
                   ...
                   <div class="inputGroup inputGroup1">
                                ...
                                <input  id="loginEmail" maxlength="254" type="email" placeholder="Էլ-հասցե" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
                            </div>
                                    ...
                                    <div class="inputGroup inputGroup2">
                                        ...
                                        <input  id="loginPassword"  placeholder="Ծածկագիր" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
                                       
                                        <input class="form-check-input" id="showPasswordCheck" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
    
                                        <label id="showPasswordToggle" for="showPasswordCheck" class="form-check-label">
                                    ...
                                    <div class="form-button">
                                            <button id="login"type="submit" class="ibtn"> Մուտք</button>
                                   </div> 
...
<script  src="{{asset('logava/js/index.js')}}"></script>
