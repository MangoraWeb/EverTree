...
<div class="background">
    ...
    <div class="weathercontainer"  style="overflow:hidden;">	
      <svg id="back">
      ...
      <div id="card" class="weather">
        ...
        <div class="details">
          ...
          <div class="right">
            <div id="date">{{$today->format('d/m/Y')}}</div>
            @if($isday == 0)
               Գիշեր
            @else 
                Ցերեկ
...
@if($isday == 0)
    ...
    document.getElementById("r1bg").style.backgroundColor = "black";

@else 
document.getElementById("r1bg").style.backgroundColor = "gray";
@endif
</script>
