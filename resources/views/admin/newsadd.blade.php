                          ...
                          <div class="row mg-b-25">
                            <div class="col-lg-12">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title"  placeholder="Վերնագիրը">
                              </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                              <div class="form-group">
                                <label class="form-control-label">Կարճ նկարագրություն՝ <span class="tx-danger">*</span></label>
                                <textarea class="form-control" type="text" name="excerpt"  placeholder="Կարճ նկարագրություն"></textarea>
                              </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" type="text" name="body"  placeholder="Կոնտենտ"></textarea>
                                </div>
                              </div><!-- col-4 -->
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="category" value="" placeholder="Կատեգորիա">
                              </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-8">
                              <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Slug՝ <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="slug" value="" placeholder="Կարճ լինք">
                              </div>
                            </div><!-- col-8 -->
                            ...
                            <div class="col-lg-4">
                              <div class="form-group mg-b-10-force">
                                ...
                                <select name="status" class="form-control select2 select2-hidden-accessible" data-placeholder="Ընտրեք ստատուսը" tabindex="-1" aria-hidden="true">
